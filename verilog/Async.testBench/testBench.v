...
module testBench
  ...
  // register begin
  always @(posedge \Async.testBench_clk  or  posedge  c$rst) begin : s_register
    if ( c$rst) begin
      s <= 4'd0;
    end else begin
      s <= result_1;
  ...
  always @(posedge \Async.testBench_clk ) begin
  ...
  // register begin
  always @(posedge \Async.testBench_clk  or  posedge  c$rst_0) begin : f_register
    if ( c$rst_0) begin
      \f'  <= 1'b0;
    end else begin
      \f'  <= (s == 4'd14);
  ...
  assign \Async.testBench_clk  = clk;
  // pragma translate_on
  // tbClockGen end
  ...
  // register begin
  always @(posedge \Async.testBench_clk  or  posedge  c$rst_1) begin : c$ds_app_arg_0_register
    if ( c$rst_1) begin
      c$ds_app_arg_0 <= 3'd0;
    end else begin
  ...
  // register begin
  always @(posedge \Async.testBench_clk  or  posedge  c$rst_2) begin : s_0_register
    if ( c$rst_2) begin
      s_0 <= 4'd0;
    end else begin
      s_0 <= c$ds_app_arg_1;
